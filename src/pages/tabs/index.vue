...
<view class="page">
  ...
  <c-tabs :value="0" :items="items" :item="{ lineProps: { width: '1px' } }" />
  <c-tabs :value="0" :items="items" :item="{ lineProps: { width: '10rpx' } }" />
  <c-tabs :value="0" :items="items" :item="{ lineProps: { width: '10rpx', round: false } }" />
</view>
</template>
